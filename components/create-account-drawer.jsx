...
import { accountSchema } from '@/libs/schema'
...
const CreateAccountDrawer = ({children}) => {
    ...
    const {data:newAccount, error, fetchData:createAccountFn, loading:createAccountLoading} = useFetch(createAccount)
                    ...
                    <form className='space-y-4' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='space-y-2'>
                            ...
                            <Select onValueChange={(value)=>setValue('type', value)} defaultValue={watch('type')}>
                                <SelectTrigger id='type' className="w-full" {...register('type')}>
                        ...
                        <div className='space-y-2'>
                            ...
                            <Input id='balance' {...register('balance')} placeholder="0.00" type="number" step="0.01" />
