...
import { ChevronDown, ChevronUp, Clock, MoreHorizontal, RefreshCcw, SearchIcon, Trash, X } from 'lucide-react'
...
const TransactionTable = ({ transactions }) => {
    ...
    const {loading:deleteLoading, fetchData:deleteFn, data:deleted}= useFetch(bulkDeleteTransaction)
                            ...
                            filteredAndSortedTransactions.map((transaction) => (
                                <TableRow key={transaction.id}>
                                    ...
                                    <TableCell className="capitalize">
                                        <span style={{ backgroundColor: categoryColors[transaction.category] }} className="px-2 py-1 rounded text-sm text-white">
